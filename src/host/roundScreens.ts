...
/**
 * Round intro and result screens for Flatterfluff.
 *
...
function renderIntro(scene: Phaser.Scene, state: RoundScreenState): void {
  ...
  addText(
    ...
    flatterfluffManifest.displayName,
    {
...
function renderResult(scene: Phaser.Scene, state: RoundScreenState): void {
  ...
  addText(scene, layer, panelX, 122, state.message ?? flatterfluffManifest.displayName, {
    fontFamily: theme.bodyFont,
    fontSize: "20px",
    color: theme.muted,
